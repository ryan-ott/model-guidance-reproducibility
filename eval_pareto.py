...
def main(args):
    ...
    result_dict = dict()
    for model_checkpoint in os.listdir(args.checkpoint_path):
        print(f'model_checkpoint: {model_checkpoint}')
        if model_checkpoint is not None:
            checkpoint = torch.load(os.path.join(args.checkpoint_path, model_checkpoint))
        ...
        result_dict[model_checkpoint] = metrics
    ...
    print(f'Saving final results in result_jsons/{args.model_backbone}_{args.attribution_method}_{args.layer}_{args.localization_loss_fn}_{args.mode}_{args.percent}.json ...')
    with open(f'result_jsons/{args.model_backbone}_{args.attribution_method}_{args.layer}_{args.localization_loss_fn}_{args.mode}_{args.percent}.json', 'w') as f:
